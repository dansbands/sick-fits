...
describe("<CreateItem/>", () => {
  ...
  it("uploads a file when changed", async () => {
    ...
    //   "https://api.cloudinary.com/v1_1/dvlpr18bj/image/upload",
    //   {"body": {Symbol(impl): {"_entries": [{"name": "file", "value": "fakedog.jpg"}, {"name": "upload_preset", "value": "sickfits"}], Symbol(wrapper): [Circular]}}, "method": "POST"}); // doesnt work, but it should
